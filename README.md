...
thinking of making a vox tonelab style tone selection on SW bank mode, which switches between group of 4 tones. 0-1 to 0-4 is hw preset, 1-1 to 1-4 is first set of sw preset, 2-1 to 2-4 is second set of sw preset, etc., ... (see "VoxMod" branch)
